...

{
    ...
    void Start()
    {
        ...
        Instantiate(leftTarget, startSpawn + new Vector3(0f, -4.25f, 0f), transform.rotation);
        Instantiate(rightTarget, startSpawn + new Vector3(1.5f, -4.25f, 0f), transform.rotation);
    }

...
files = [
    ('./Conga_bip FIRST DRAFT.wav', 'Conga_bip FIRST DRAFT.json'),
    ('./Khol_bip FIRST DRAFT.wav', 'Khol_bip FIRST DRAFT.json'),
    ('./Taiko_bip_1 FIRST DRAFT.wav', 'Taiko_bip_1 FIRST DRAFT.json')
